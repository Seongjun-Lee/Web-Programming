					...
					<table>
						...
						<tr>
                            ...
                            if(isset($_GET[num])) { //update 의 경우!
                                ?>
                                <td class="column1"> <input name="date" type="text" value="<? #TODO: 정보 표시
                                    echo ($row[date]); ?>" /> </td>
                                <td class="column2"> <input name="order_id" type="number" value="<? #TODO: 정보 표시
                                    echo ($row[order_id]); ?>" /> </td>
                                <td class="column3"> <input name="name" type="text" value="<?  #TODO: 정보 표시
                                    echo ($row[name]); ?>" /> </td>
                                <td class="column4"> <input name="price" type="number" placeholder="$" style="text-align: right;" value="<? #TODO: 정보 표시
                                    echo ($row[price]); ?>" /> </td>
                                <td class="column5"> <input name="quantity" type="number" value="<? #TODO: 정보 표시
                                    echo ($row[quantity]); ?>" style="text-align: right;" /> </td>
                                <td class="column6"> $<span id="total"> <? #TODO: 정보 표시
