...
mysql_selectdb("lsj_db", $connect);

?>
<div id="POPOption" class="thumbnailsPOPLogin">
    <?php
            ...
            <div style="padding-top: 5%">
                <table class="UserInfo_Table">
                    <tr>
                        ...
                        <td>
                            <input class="Register_Input" type="text" name="title" minlength="1"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="Register_Input" type="text" name="company" minlength="1"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="Register_Input" type="text" name="image" minlength="3"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
