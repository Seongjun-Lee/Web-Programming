...
insert into GameDB(title, device, point, company, location, image)values('Tom Clancys The Division 2', 'PC', 84, 'Massive Entertainment', 'https://store.playstation.com/ko-kr/product/JP0001-CUSA12615_00-ASIAPLACEHOLDER0?smcid=web%3Apsn%3Aprimary%20nav%3Asearch%3Ared%20dead%20redemption%202', 'https://upload.wikimedia.org/wikipedia/en/a/af/The_Division_2_art.jpg');
